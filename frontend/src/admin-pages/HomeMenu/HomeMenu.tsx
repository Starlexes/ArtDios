	...
	return (
		<section>
			<div className={cn(styles['home-menu'], className)}>
				...
				<AdminPageHead>Главная</AdminPageHead>

				<ModelItems>
					<ModelItem
						link={adminEditCategory + adminEditCategoryMenuRoute}
					>
						Редактирование категорий
					</ModelItem>

					<ModelItem
						link={adminEditCatalog + adminEditCategoryMenuRoute}
					>
					...
					<ModelItem
						link={adminEditPromotions + adminEditCategoryMenuRoute}
					>
						Акции
					</ModelItem>

					<ModelItem
						link={adminEditContacts + adminEditCategoryMenuRoute}
					>
						Контакты
					</ModelItem>

					<ModelItem link={adminEditGallery}>Галерея</ModelItem>
				</ModelItems>
			</div>
		</section>
	);
