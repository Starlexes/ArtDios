...
function ModalForm({
	...
	return (
		<form
			...
			className={cn(styles['modal-form'], className)}
		>
			<div className={cn(styles['form-inputs'])}>
				<label>
					{isSubmitAttempted && errors.name && (
						<span className={cn(styles['error-msg'])}>
							{errors.name}
						</span>
					)}
					<ModalInput
			...
			<div className={cn(styles['checkbox-block'])}>
				<ModalInput
					...
					onChange={handleChange}
					hasError={
						(isSubmitAttempted && errors.agreement) as boolean
					}
				/>
				<label htmlFor="agreement">
					<p>
						...
						<NavItem
							...
							to={opdPageRoute}
							className={cn(styles['modal-label'])}
						>
