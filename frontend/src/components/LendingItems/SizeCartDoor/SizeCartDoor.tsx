...
function SizeCartDoor({ className }: SizeCartDoorProps) {
	...
	return matches ? (
		<div className={cn(styles['size-cart-doors'], className)}>
			<SizeCartDoorItem>
				<img
					src={mediaImagesPath + '/lending/size-door1.png'}
					alt="Подбор"
				/>
			...
			<SizeCartDoorItem>
				<img
					src={mediaImagesPath + '/lending/size-door2.png'}
					alt="Подбор"
				/>
			...
			<SizeCartDoorItem>
				<img
					src={mediaImagesPath + '/lending/size-door3.png'}
					alt="Подбор"
				/>
			...
			<SizeCartDoorItem>
				<img
					src={mediaImagesPath + '/lending/size-door4.png'}
					alt="Подбор"
				/>
