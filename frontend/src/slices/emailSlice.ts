...
export const fetchEmail = createAsyncThunk<
	...
	void,
	{ rejectValue: string }
>('emails/fetchEmail', async (_, { rejectWithValue }) => {
	try {
...
export const updateEmail = createAsyncThunk<
	...
	UpdateEmailState,
	{ rejectValue: string }
>('emails/updateEmail', async ({ id, data }, { rejectWithValue }) => {
	try {
...
export const addEmail = createAsyncThunk<
	...
	UpdateEmail,
	{ rejectValue: string }
>('emails/addEmail', async (data, { rejectWithValue }) => {
	try {
...
export const deleteEmail = createAsyncThunk<
	...
	number,
	{ rejectValue: string }
>('emails/deleteEmail', async (id, { rejectWithValue }) => {
	try {
