...
export const fetchCategory = createAsyncThunk<
	...
	void,
	{ rejectValue: string }
>('categories/fetchCategory', async (_, { getState, rejectWithValue }) => {
...
export const addCategory = createAsyncThunk<
	...
	UpdateCategoryState,
	{ rejectValue: string }
>('categories/addCategory', async (data, { rejectWithValue }) => {
	try {
...
export const updateSubCategory = createAsyncThunk<
	...
	UpdateCategory,
	{ rejectValue: string }
>('categories/updateSubCategory', async ({ id, data }, { rejectWithValue }) => {
	try {
...
export const addSubCategory = createAsyncThunk<
	...
	{ rejectValue: string }
>('categories/addSubCategory', async (data, { rejectWithValue }) => {
	try {
...
const categorySlice = createSlice({
	...
	extraReducers: (builder) => {
		...
		builder.addCase(
			...
			(state, action: PayloadAction<SubCategoryState>) => {
