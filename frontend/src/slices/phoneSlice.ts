...
export const fetchPhone = createAsyncThunk<
	...
	void,
	{ rejectValue: string }
>('phones/fetchPhone', async (_, { rejectWithValue }) => {
	try {
...
export const updatePhone = createAsyncThunk<
	...
	UpdatePhoneState,
	{ rejectValue: string }
>('phones/updatePhone', async ({ id, data }, { rejectWithValue }) => {
	try {
...
export const addPhone = createAsyncThunk<
	...
	UpdatePhone,
	{ rejectValue: string }
>('phones/addPhone', async (data, { rejectWithValue }) => {
	try {
...
export const deletePhone = createAsyncThunk<
	...
	number,
	{ rejectValue: string }
>('phones/deletePhone', async (id, { rejectWithValue }) => {
	try {
