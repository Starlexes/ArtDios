...
export const fetchProductType = createAsyncThunk<
	...
	void,
	{ rejectValue: string }
>('productTypes/fetchProductType', async (_, { rejectWithValue }) => {
	try {
...
export const addProductType = createAsyncThunk<
	...
	ProductType,
	{ rejectValue: string }
>('productTypes/addProductType', async (data, { rejectWithValue }) => {
	try {
...
export const deleteProductType = createAsyncThunk<
	...
	number,
	{ rejectValue: string }
>('productTypes/deleteProductType', async (id, { rejectWithValue }) => {
	try {
