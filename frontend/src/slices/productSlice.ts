...
>('product/fetchProduct', async (params, { rejectWithValue }) => {
	try {
		...
		const response = await axios.get(
			`/api/product/?${stripChars(queryString, '&')}`
		);
...
export const updateProductCard = createAsyncThunk<
	Product,
...
export const addProductCard = createAsyncThunk<
	...
	FormData,
	{ rejectValue: string }
>('productCard/addProductCard', async (data, { rejectWithValue }) => {
	try {
...
export const deleteProductCard = createAsyncThunk<
	number,
	number,
	{ rejectValue: string }
>('productCard/deleteProductCard', async (id, { rejectWithValue }) => {
	try {
...
export const deleteProducts = createAsyncThunk<
	...
	number[],
	{ rejectValue: string }
>('productCard/deleteProducts', async (ids, { rejectWithValue }) => {
	try {
