	...
	return (
		<section>
			<div className={cn(styles['offer-page'], className)}>
              ...
              www.адрес, организационно-правовая форма,полное наименование
              организации, ИП, и юридическим адресом юридический адрес, в
              лице должность уполномоченного лица, ФИО, действующего (- ей) на
              основании указать документ, удостоверяющий полномочия и его
              реквизиты, именуемое в дальнейшем «Продавец», публикует Публичную
              оферту о продаже Товара дистанционным способом.
					</p>
                  ...
                  Покупателя об изменении цены Товара.
                    ...
                    Интернет-магазина в разделе название раздела.
						...
						<li>						
							...
							<ol>
								<p>
                    4.1. Заказ Товара осуществляется Покупателем через Оператора
                    по телефону номер телефона или через сервис сайта
                    Интернет-магазина www. адрес раздела.
								</p>
								<p>
