				...
				<div className={cn(styles['about-content'])}>
					<div className={cn(styles['content-item'])}>
						<div className={cn(styles['logo-item'])}>
							...
							/>
							<p>
								— это оптово-розничная компания с одним из самых
								крупных складов в России.
							</p>
						</div>
					</div>
					...
					<div className={cn(styles['content-item'])}>
						...
						<ul className={cn(styles['item-list'])}>
							...
							<li>
								Собственная служба контроля оценинки качества
								работы менеджеров
							</li>
					...
					<div className={cn(styles['content-item'])}>
						...
						<p>
							Почти всю представленную продукцию в нашем магазине
							мы держим в наличии, это позволяет нам осуществлять
							оперативную отгрузку товара. Любой клиент может
							приехать и забрать продукцию со склада быстро и без
							лишних хлопот.
						</p>
					...
					<div className={cn(styles['content-item'])}>
						...
						<p>
							Для удобства мы организовали просторные выставочные
							залы, где можно увидеть и потрогать почти весь
							ассортимент дверей.
						</p>
						...
						<p>
							В нашем магазине очень большой выбор кварц-виниловой
							плитки . Наши консультанты помогут правильно
							подобрать материалы.
						</p>
						...
						<p>
							У нас индивидуальный подход ко всем клиентам. Наши
							профессионалы быстро, качественно помогут найти
							необходимый товар и уточнить все нюансы. В нашем
							каталоге вы найдете современные и актуальные товары!
						</p>
					</div>
				</div>
			</div>
